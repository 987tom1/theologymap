...
**Depth status.** P1–P8 are written to full step detail. P9–P11 carry
...
- The full-output hash may move **only** in a phase licensed to change the output on purpose.
  **Current baseline, as of P2 (2026-09-10):**
  ...
  |---|---|---|
  | **P11 Part 2 win 4 — read against this** | `dfe51d3d7bbf7bb3885de37979aa3a74f98c410043a05cacbc78e47e02ab32d1` | `b60ac34f9e7a331e0b8e725dbfcf96e8d69542c4987146084a7eeb8f3994ae57` |
  | P11 Task 2 | `fb53c031bff67968016adf6180a7670dbed709e66503c11d3a17bede8b2fcbae` | `ba9a94ab81dedd6db76d2e26364b609b00d9e284c71f1b959347e6fcd6c4bbd6` |
  ...
  P3 is a phase **licensed** to change the output on purpose — `color-scheme` and
  `accent-color` change rendered appearance — so its move is expected. Only P3's Tasks 1–2
  touch `render.py`; Tasks 3–6 do not, and the hash is unchanged from `c93d50b` onward.

  P4 is likewise **licensed** — Task 6 appends `render.py`'s own hand-copied reduced-motion
  guard to its embedded `<style>`, since it cannot link `engine/theme.css`. Only Task 6 touches
