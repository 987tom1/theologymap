...
## Trinity · T1 · certain
  hold  One God in three co-equal, co-eternal persons.
  why   The creeds settle this. To deny it is to deny the faith.
...
## Classical theism · T2 · open · #study
  hold  Sympathetic to divine simplicity, immutability, impassibility and eternity — not yet settled.
  todo  Work through simplicity and impassibility properly. Ortlund is a good entry point.
  refs  Mal 3:6; James 1:17
  link  gods-relation-to-time

## God's relation to time · T3 · open · #study
  todo  Timeless eternity, or temporal since creation? Craig's temporal-since-creation view pairs naturally with Molinism.
...
## Baptism in the Holy Spirit · T3 · confident
  ...
  refs  Acts 1:8; Acts 19:1-6
  link  sealing-of-the-spirit

## Sealing of the Spirit · T2 · confident
  hold  The sealing (Eph 1:13) is distinct from both baptism and infilling. It is God's mark of ownership and his guarantee, given to every believer at conversion.
  why   This is what keeps the subsequence doctrine from implying that some Christians lack the Spirit.
  refs  Eph 1:13; 2 Cor 1:22
  link  perseverance-and-apostasy

## Continuationism · T2 · confident
  hold  All the gifts continue. None were withdrawn with the apostles.
  vs    Cessationism.
  refs  1 Cor 12:4-11; 1 Cor 14:39

## Prophecy · T2 · open · #study
  hold  Provisionally fallible and to be weighed (Grudem) — held loosely.
  todo  The word "prophecy" is used to mean several quite different things, both in the text and in practice. Map the semantic range first; the doctrine will follow from it.
...
## Apostles and prophets today · T2 · confident
  hold  The functions continue — church planting, sending, prophetic ministry. The offices carrying governing authority do not.
  vs    NAR-style governmental apostles and prophets.
  refs  Eph 4:11-13

## Healing · T2 · confident
  hold  Secured in the atonement, but already and not yet. God genuinely heals now; full healing awaits the resurrection.
  why   Unanswered prayer is therefore not necessarily a failure of faith.
  vs    Word of Faith guarantees.
...
## Depravity and prevenient grace · T2.5 · open · #study
  todo  If grace is resistible and the human response genuinely free, what enables that response? Prevenient grace, or an unaided free will?
...
## Baptism · T2 · leaning · #study
  hold  Believers only, by immersion, and genuinely instrumental — a means of grace, not merely a public symbol.
  todo  What does a "means of grace" actually do? Resolve this alongside the Lord's Supper; they are one question.
...
## Israel and the church · T3 · leaning · #study
  hold  Progressive covenantalism — the church fulfils the promises in Christ without simply replacing Israel, and Rom 11 keeps a real future for ethnic Israel.
  vs    Both dispensationalism and strict replacement theology.
  todo  Keen to study further. This node largely determines the millennium and rapture nodes.
  refs  Rom 11:17-24; Rom 11:25-26
...
## Intermediate state · T3 · confident
  hold  The dead in Christ are consciously with him, awaiting the resurrection of the body.
...
## Creation ex nihilo and design · T1.5 · certain
  hold  God created deliberately, out of nothing, with purpose.
...
## Divine council · T3 · open · #study
  todo  Heiser's reading of Psalm 82, Deut 32:8-9 and Genesis 6. Interested, not yet convinced. Assess the ancient Near Eastern background case on its merits.
  refs  Ps 82:1; Deut 32:8-9

## Genesis 6 sons of God · T3 · open · #study
  todo  Angelic view or Sethite line. Rides on the divine council question.
  refs  Gen 6:1-4; Jude 1:6
  link  divine-council
...
## Marriage and sexuality · T2 · certain
  hold  Marriage is between one man and one woman. Same-sex sexual activity is sin. Held with warmth, not hostility.
  why   Same-sex attraction is temptation, in the same category as temptation toward drunkenness, greed or idolatry. The temptation is not itself the sin.
...
## Divorce and remarriage · T3 · leaning · #study
  hold  Adultery, desertion, and abuse named explicitly as its own ground rather than squeezed under desertion.
...
## Sanctification — definitive · T2 · confident
  hold  Past tense and accomplished. "You were sanctified" (1 Cor 6:11); "sanctified through the offering of the body of Jesus Christ once for all" (Heb 10:10). Set apart, already.
  why   This is the language that makes "already sanctified" true without contradicting ongoing growth.
  refs  1 Cor 6:11; Heb 10:10
  link  sanctification-progressive

## Sanctification — progressive · T2 · leaning · #study
  hold  Genuine transformation over a lifetime, Spirit-empowered and cooperative, punctuated by crisis moments that do real and lasting work.
  vs    Wesleyan entire sanctification; and equally the passive "let go and let God" model.
  todo  Sharpen the definitions and the relationship between the three tenses.
  refs  2 Cor 3:18; Gal 5:22-23

## Sanctification — final · T2 · confident
  hold  Completed at glorification. Sin remains until then.
...
## Hearing God · T2 · confident · #study
  hold  God guides chiefly through Scripture, renewed thinking, wise counsel and circumstance. Impressions, dreams and prophetic words are genuine but subordinate, and always testable.
  vs    The "God told me" culture that places a decision beyond challenge.
  todo  Same root problem as prophecy — the vocabulary is being made to do too many jobs at once.
...
## Prima scriptura · T1.5 · confident
  hold  Scripture is the final authority; tradition is a real but ministerial authority beneath it.
  vs    Biblicism that treats church history as mere data; and any account that makes tradition a second source.
  refs  Acts 17:11; 2 Tim 3:16-17
